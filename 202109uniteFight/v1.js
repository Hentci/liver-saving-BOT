...
function quest() {
    const checkQueBtn = () => $("#cnt-quest > div.prt-supporter-list.prt-module > div:nth-child(4) > div:nth-child(2) > div.prt-button-cover").length === 1;
    const maxLoop = 50;
    let loopCount = 0;
    const func = () => {
        loopCount++;
...
function raid() {
    const skill = [
        {
            character: "#prt-command-top > div > div > div.lis-character0.btn-command-character > img",
            ability: "#wrapper > div.contents > div.cnt-raid > div.prt-command > div.prt-command-chara.chara1 > div.prt-ability-list > div:nth-child(1) > div.ability-character-num-1-1 > img",
        },
        {
            character: "#wrapper > div.contents > div.cnt-raid > div.prt-command > div.prt-command-summon > div > div.prt-list-top.btn-command-summon.summon-on",
