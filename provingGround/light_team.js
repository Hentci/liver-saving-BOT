...
function quest() {
    const checkQueBtn = () => $("#prt-supporter-list > div.prt-supporter-attribute.type5 > div:nth-child(2) > div.prt-button-cover").length === 1;
    const maxLoop = 50;
    let loopCount = 0;
    const func = () => {
        loopCount++;
        ...
        if(checkQueBtn()) {
            $("#prt-supporter-list > div.prt-supporter-attribute.type5 > div:nth-child(2) > div.prt-button-cover").trigger("tap");

            setTimeout(() => {
                $("#pop-confirm-sequence > div.prt-buttons > div.btn-usual-ok.se-quest-start.on").trigger("tap");
            }, 3000);
