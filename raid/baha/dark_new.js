...
// const test = document.querySelector("#wrapper > div.contents > div.cnt-raid > div.prt-presages-condition.show");
...
function quick_raid() {
    ...
    const func = () => {
        ...
        } else if (currHP_num <= 90 && currHP_num >= 50){
            setTimeout(() => {
                location.reload();
            }, 900);   
        } else if (currHP_num == 25){
            setTimeout(() => {
                location.reload();
            }, 400);   
        } else if (loopCount < maxLoop) {
